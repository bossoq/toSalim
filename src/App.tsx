...
const App = () => {
  ...
  const [text, setText] = useState<string>('ล้างสมอง')
  ...
  const copyText = () => {
    navigator.clipboard.writeText(`${respText} #toSalim`)
    setCopied(true)
    setTimeout(() => {
      setCopied(false)
    }, 2000)
        ...
        <div className="m-4">
          <div className="flex flex-col justify-center gap-6">
            <div className="md:text-8xl text-6xl m-4 text-center font-bold">
              <p className="animate-bounce inline-block text-black dark:text-white">
                to Salim 🙏🏻💛🇹🇭
              </p>
            </div>
